		    ...
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
					...
					<div class="auth-form-container text-start mx-auto">
                        ...
                        ?>
						<form class="auth-form auth-signup-form" action="php/proses-patient.php" method="POST">
                            ...
                            <input name="level" type="hidden" class="form-control signup-name" value="patient">
                            <div class="email mb-3">
                                <label class="sr-only" for="signup-email">IC Passport</label>
                                <input id="signup-name" name="ICPassport" type="text" class="form-control signup-name" placeholder="IC Passport" required="required">
                            </div>
