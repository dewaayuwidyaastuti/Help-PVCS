...
<head>
    <title>Help PCVS Request Vaccination Appointment</title>
                ...
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link active" href="index.php">
                            ...
                            <span class="nav-link-text">Request Vaccination Appointment</span>
                        </a><!--//nav-link-->
                    </li><!--//nav-item-->
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">The Available Vaccine & Manufacturer</h1>
                </div>
                ...
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-4">
                        <h3 class="section-title">Input Vaccine ID :</h3>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                ...
                                <form class="settings-form" action="" method="POST">
                                    ...
                                    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
                                        <div class="inner">
                                            <label for="setting-input-1" class="form-label">Vaccine Batch Information :</label>
                                            <div class="row gx-5 gy-3">

                                                <!--TABLE Vaccine Batch Information -->
                                                <div class="tab-content" id="orders-table-tab-content">
                                                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                                                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                                                            <div class="app-card-body">
                                                                <div class="table-responsive">
                                                                    <table class="table app-table-hover mb-0 text-left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="cell">Healthcare Centre</th>
                                                                            <th class="cell">Address</th>
                                                                            <th class="cell">Expiry Date</th>
                                                                            <th class="cell">Quantity of Available</th>
                                                                            <th class="cell">Quantity of Administered</th>
                                                                        </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                        <?php
                                                                        ...
                                                                        $listvaccine = mysqli_query($koneksi, "select * from batch 
																											  ...
																											  where batch.vaccineID = $vaccineID");
                                                                        while ($row = mysqli_fetch_array($listvaccine)){

                                                                            ?>
                                                                            <tr>
                                                                                <td class="cell"><?php echo $row['batchNo']?></td>
                                                                                <td class="cell"><?php echo $row['centreName']?></td>
                                                                                <td class="cell"><?php echo $row['address']?></td>
                            ...
                            <form class="settings-form" action="proses-request.php" method="POST">
                                <input type="hidden" class="form-control" name="fullname" value="<?php echo $_SESSION['fullname'] ?>">
                                ...
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Appointment Date :</label>
                                    <input type="date" class="form-control" name="appointmentDate" id="setting-input-2" >
                                </div>

                                <input name="submit" type="submit" class="btn app-btn-primary" value="Request">
                            </form>
                        </div><!--//app-card-body-->
                    </div><!--//app-card-->
                </div>
